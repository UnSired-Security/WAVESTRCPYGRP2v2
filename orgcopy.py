...
if response == 1:
  ...
  bana = input("Enter Bank Name ")
  bena = str(input("Enter Beneficiary's Name>>  ")).upper()
  dest = int(input("Enter Destination account number>>  "))
  while len(str(dest)) <10 or len(str(dest))>10:
      retry = input("Unable To Find an account ,Please Enter A Valid Account Number >   ")
      if len(str(retry)) == 10:
          print("Account Found!")
          break
  else:
...
while response == 7:
    print("QUIT,Closing FIRST BANK USSD CODE...")
    break
else:
